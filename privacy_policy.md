BTC Badge Privacy Policy

Last updated: 2026-07-14

BTC Badge does not collect, store, transmit, or sell any personal data.


No data collection. The extension has no analytics, no tracking, and no account system.
Local storage only. User preferences (selected exchange, display toggles, chart timeframe, overlay position) and the latest cached price are stored in the browser's local extension storage and never leave your device.
